...
export const dummyFeeders: Feeder[] = [
  ...
  },
  {
    ...
    breachMargin: 21.9,
    critical: false,
    coordinates: [37.8020, -122.4650]
  },
  {
    id: 'feeder-12',
    name: 'Nob Hill Feeder',
    region: 'Central',
    capacity: 95,
    currentLoad: 82,
    projectedLoad: 91,
    breachMargin: 4.2,
    critical: false,
    coordinates: [37.7940, -122.4170]
  },
  {
    id: 'feeder-13',
    name: 'Financial District Feeder',
    region: 'Central',
    capacity: 140,
    currentLoad: 121,
    projectedLoad: 135,
    breachMargin: 3.6,
    critical: true,
    coordinates: [37.7950, -122.3980]
  },
  {
    id: 'feeder-14',
    name: 'Outer Richmond Feeder',
    region: 'West',
    capacity: 70,
    currentLoad: 42,
    projectedLoad: 55,
    breachMargin: 21.4,
    critical: false,
    coordinates: [37.7780, -122.5020]
  },
  {
    id: 'feeder-15',
    name: 'Potrero Hill Feeder',
    region: 'South',
    capacity: 85,
    currentLoad: 76,
    projectedLoad: 82,
    breachMargin: 3.5,
    critical: false,
    coordinates: [37.7570, -122.3980]
  },
  {
    id: 'feeder-16',
    name: 'Twin Peaks Feeder',
    region: 'Central',
    capacity: 75,
    currentLoad: 55,
    projectedLoad: 65,
    breachMargin: 13.3,
    critical: false,
    coordinates: [37.7550, -122.4470]
  },
  {
    id: 'feeder-17',
    name: 'Bernal Heights Feeder',
    region: 'South',
    capacity: 65,
    currentLoad: 58,
    projectedLoad: 63,
    breachMargin: 3.1,
    critical: true,
    coordinates: [37.7400, -122.4130]
  },
  {
    id: 'feeder-18',
    name: 'Haight-Ashbury Feeder',
    region: 'Central',
    capacity: 80,
    currentLoad: 54,
    projectedLoad: 68,
...
export const dummyDerAssets: DerAsset[] = [
  ...
  },
  {
    id: 'der-16',
    type: 'EV',
    name: 'Presidio EV Station',
    location: 'Presidio',
    coordinates: [37.8010, -122.4660],
    availability: 85,
    trustScore: 92,
    capacity: 18
  },
  {
    id: 'der-17',
    type: 'thermostat',
    name: 'Twin Peaks Apartments',
    location: 'Twin Peaks',
    coordinates: [37.7560, -122.4480],
    availability: 88,
    trustScore: 84,
    capacity: 12
  },
  {
    id: 'der-18',
    type: 'battery',
    name: 'Bernal Heights Community Battery',
    location: 'Bernal Heights',
    coordinates: [37.7410, -122.4140],
    availability: 92,
    trustScore: 89,
    capacity: 16
  },
  {
    id: 'der-19',
    type: 'EV',
    name: 'Outer Richmond Charging',
    location: 'Outer Richmond',
    coordinates: [37.7770, -122.5010],
    availability: 78,
    trustScore: 82,
    capacity: 14
  },
  {
    id: 'der-20',
    type: 'thermostat',
    name: 'Financial District Office Thermostats',
    location: 'Financial District',
    coordinates: [37.7960, -122.3990],
    availability: 95,
    trustScore: 94,
    capacity: 22
  },
  {
    id: 'der-21',
    type: 'battery',
    name: 'UCSF Medical Center Battery',
    location: 'Inner Sunset',
    coordinates: [37.7630, -122.4580],
    availability: 98,
    trustScore: 96,
    capacity: 30
  },
  {
    id: 'der-22',
    type: 'EV',
    name: 'Fort Mason EV Chargers',
    location: 'Marina',
    coordinates: [37.8070, -122.4320],
    availability: 82,
    trustScore: 88,
    capacity: 16
  },
  {
    id: 'der-23',
    type: 'thermostat',
    name: 'Chinatown Building Network',
    location: 'Chinatown',
    coordinates: [37.7950, -122.4070],
    availability: 90,
    trustScore: 86,
    capacity: 18
  },
  {
    id: 'der-24',
    type: 'battery',
    name: 'Dogpatch Microgrid',
    location: 'Dogpatch',
    coordinates: [37.7580, -122.3880],
    availability: 94,
    trustScore: 91,
    capacity: 24
  },
  {
    id: 'der-25',
    type: 'EV',
    name: 'Glen Park Charging Station',
    location: 'Glen Park',
    coordinates: [37.7380, -122.4340],
    availability: 88,
    trustScore: 84,
    capacity: 15
  }
